              ...
              <div className="flex space-x-4">
                ...
                {profile.social.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 rounded-full flex items-center justify-center hover:opacity-90 transition-all duration-200 cursor-pointer hover:scale-110 transform hover:shadow-lg hover:shadow-pink-600/50"
                  >
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
